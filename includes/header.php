<?php 
    ...
    session_start();
    define("APPURL","http://localhost/HurtadoFE");
    
    define("IMGURLCATEGORY", "http://localhost/HurtadoFE/admin-panel/categories-admins/img_category");
    define("IMGURLPRODUCT", "http://localhost/HurtadoFE/admin-panel/products-admins/img_product");
...
<html>
<head>
    <title>HurtadoFE | Groceries Organic Store</title>
    <meta charset="utf-8">
